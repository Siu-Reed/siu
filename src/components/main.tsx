...
const Main:React.FC<Props> = memo(({polygonClick, aboutSwitch, aboutOpen, aboutClose}) => {
    ...
    return (
        <div className={styles.main}>            <svg className={styles.lineBG} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1920 1080" xmlSpace="preserve">
                ...
                <path fill="none" stroke="#879678" stroke-miterlimit="10" d="M1809.4,976.6c-5.5,2.9-11.4,5.8-17.6,8.9   c-94.8,47.4-121.2,95.4-121.2,95.4H1920V931v-47.4C1900.3,918.1,1888.3,935.7,1809.4,976.6z"/>        
            </svg>
